...
class HalloweenTheme : Theme {
    ...
    override fun getBanTitle(): String = ColorUtil.colorize("&6&l\u2620 &c&lDEATH CLAIMS YOU &6&l\u2620")

    override fun getBanSubtitle(duration: String): String = ColorUtil.colorize("&8Your soul is trapped for &6$duration")
    ...
    override fun getReturnTitle(): String = ColorUtil.colorize("&a&l\u2605 RESURRECTION \u2605")

    override fun getReturnSubtitle(): String = ColorUtil.colorize("&7You have risen from the grave")

    override fun getReturnMessage(): String = ColorUtil.colorize("&6\u2620 &7The spirits release you... &afor now. &7Be wary, mortal!")

    override fun getWarningFinalLife(): String = ColorUtil.colorize("&6\u2620 &c&lDEATH LOOMS! &7One more fall and your soul is forfeit!")
