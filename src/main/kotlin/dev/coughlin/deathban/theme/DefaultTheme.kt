...
class DefaultTheme : Theme {
    ...
    override fun getBanTitle(): String =
        ColorUtil.colorize("&c&lYOU DIED")

    override fun getBanSubtitle(duration: String): String =
        ColorUtil.colorize("&7Banned for &e$duration")
    ...
    override fun getReturnTitle(): String =
        ColorUtil.colorize("&a&lWELCOME BACK")

    override fun getReturnSubtitle(): String =
        ColorUtil.colorize("&7Your ban has expired")

    override fun getReturnMessage(): String =
        ColorUtil.colorize("&aYou have returned from your death ban. Be careful!")

    override fun getWarningFinalLife(): String =
        ColorUtil.colorize("&c&lWARNING: &7This is your final life! Next death = ban.")
